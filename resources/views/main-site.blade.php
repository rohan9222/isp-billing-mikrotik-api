			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 col">
						...
						<div class="map">
							<div id="googleMap">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d97559.35009863286!2d90.89949961876307!3d24.672873925245927!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3756e83b9c19e2e5%3A0xa7695289d8c1a5c1!2sMadan%20Upazila!5e0!3m2!1sen!2sbd!4v1770660584969!5m2!1sen!2sbd" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
						</div>
						<!--/map-->
					...
					<div class="col-10">
						<div class="">
							<a href="#top">
                                @if (siteUrlSettings('site_logo'))
                                    @if (file_exists(public_path(siteUrlSettings('site_logo'))))
                                        <img class="d-inline-block align-text-top" src="{{ asset(siteUrlSettings('site_logo')) }}" alt="logo"/>
                                    @else
                                        <img class="d-inline-block align-text-top" src="{{ asset('images/logo.png') }}" alt="logo"/>
                                    @endif
                                @else
                                    @if (siteUrlSettings('site_icon'))
                                        <img class="d-inline-block align-text-top" src="{{ asset(siteUrlSettings('site_icon')) }}" alt="" width="40" />
