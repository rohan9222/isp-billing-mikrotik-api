...
class FirewallSetup extends Component
{
    ...
    {
        $this->n_chain = 'srcnat'; $this->n_action = 'masquerade'; $this->n_comment = 'Auto-masquerade';
        $this->addNatRule();
    }
    ...
    private function resetData(): void { $this->filterRules = $this->natRules = $this->mangleRules = $this->addressLists = $this->interfaces = []; }
